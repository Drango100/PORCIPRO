              ...
              <div className="relative">
                ...
                >
                  {showPwd ? (
                    ...
                    // eye
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 5.25c-5.03 0-8.79 4.29-10.8 7.05a1.5 1.5 0 0 0 0 1.99C3.21 16.96 6.97 21.25 12 21.25s8.79-4.29 10.8-7.05a1.5 1.5 0 0 0 0-1.99C20.79 9.54 17.03 5.25 12 5.25Zm0 12a5 5 0 1 1 0-10 5 5 5 0 0 1 0 10Z"/>
